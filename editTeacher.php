	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				...
				<h1>
					<CENTER>Edit Teacher</CENTER>
				</h1>
				<div class="col-sm-6 col-sm-offset-3">
					<form class="form-horizontal" action="./updateTeacher.php" method="POST">
							...
							<div class="col-sm-10">
								<?php
									...
									if ($mysqli->connect_errno) {
										...
										$query = "SELECT * FROM teacher WHERE tid = ". $_GET['id'];
										if ( $result = $mysqli->query($query) ) {
											$obj = $result->fetch_object();
											echo "<input type='text' class='form-control' name='inputName' value='". $obj->name ."' required/>" ;
										} // if
										else
											echo "No result" ;
									} // else
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<?php
									echo "<input type='text' class='form-control' name='inputAdj' value='". $obj->adj ."' required/>" ;
								?>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<?php
									echo "<textarea class='form-control' rows='3' name='inputSpecial' required>". $obj->speciality ."</textarea>" ;
								?>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<?php
									...
									echo "<input type='hidden' class='form-control' name='tid' value='". $_GET['id'] ."' required/>";
								?>
							</div>
						</div>
						<div class="form-group">
...
<script>
	$('#del_btn').click(function() {
		if ( confirm( "Delete teacher's profile?" ) ) {
			location.href = './deleteTeacher.php?id='+<?php echo $_GET["id"]; ?> ;
		}
	});
</script>
</html>