		...
		<div class="row">
			<div class="col-md-12">
				<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							...
							<li>
								<a href="http://uip.cycu.edu.tw/UIPWeb/wSite/ct?xItem=71303&ctNode=23177&mp=8004" target="_blank">風雅頌</a>
							</li>
							<li>
				...
				<div class="col-sm-6 col-sm-offset-3">
					<form class="form-horizontal" action="./updatePost.php" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<?php
									echo "<textarea class='form-control' rows='10' name='inputContent' required>". $obj->content ."</textarea>";
									echo "<input type='hidden' name='nid' value='". $_GET['id'] ."' />";
								?>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select class="form-control" name="category">
								    <?php
								    	if ( $obj->category == 1 )
								    		echo "<option value='1' selected>Activity</option><option value='2'>Class</option>";
								    	else
								    		echo "<option value='1'>Activity</option><option value='2' selected>Class</option>";
								    ?>
								</select>
							</div>
						</div>
...
<script>
	$('#del_btn').click(function() {
		if ( confirm( "Delete post?" ) ) {
			location.href = './deleteNews.php?id='+<?php echo $_GET["id"]; ?> ;
		}
	});
</script>
</html>