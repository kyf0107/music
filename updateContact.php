<?php
	...
	else if ( !isset( $_POST['inputID'] ) || !isset( $_POST['inputTitle'] ) || !isset( $_POST['inputURL'] ) )
		echo "<script>alert('Please complete the form'); location.href='./contactEditor.php';</script>";
	else {
		$query = "CALL sp_updateContact( ". $_POST['inputID'] .", '". $mysqli->real_escape_string( htmlentities( $_POST['inputTitle'] ) ) ."', '". $mysqli->real_escape_string( htmlentities( $_POST['inputURL'] ) ) ."' )";
