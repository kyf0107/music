		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-sm-6 col-sm-offset-3">
					<form class="form-horizontal" action="./insertTeacher.php" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="inputAdj" required/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea class="form-control" rows="3" name="inputSpecial" required></textarea>
							</div>
						</div>
						<div class="form-group">
