				...
				<div class="col-sm-6 col-sm-offset-3">
					<form class="form-horizontal" action="./updateCollection.php" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<?php
									echo "<input type='text' class='form-control' name='inputAuthor' value='". $obj->author ."' required/>" ;
								?>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<?php
									echo "<input type='text' class='form-control' name='inputIntro' value='". $obj->introduction ."' required/>" ;
								?>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<?php
									echo "<textarea class='form-control' rows='3' name='inputContent' required>". $obj->content ."</textarea>" ;
								?>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<?php
									...
									echo "<input type='hidden' class='form-control' name='cid' value='". $_GET['id'] ."' required/>";
								?>
							</div>
						</div>
						<div class="form-group">
...
<script>
	$('#del_btn').click(function() {
		if ( confirm( "Delete teacher's profile?" ) ) {
			location.href = './deleteCollection.php?id='+<?php echo $_GET["id"]; ?> ;
		}
	});
</script>
</html>